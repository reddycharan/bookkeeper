...
public class RoundRobinDistributionScheduleTest {
    ...
    public void testRRQuorumCoverageSet() throws Exception {
        ...
        rrQuorumCoverageSet.addBookie(0, BKException.Code.NoSuchLedgerExistsException);
        rrQuorumCoverageSet.addBookie(1, BKException.Code.OK);
        rrQuorumCoverageSet.addBookie(2, BKException.Code.NoSuchLedgerExistsException);
        rrQuorumCoverageSet.addBookie(3, BKException.Code.OK);
        rrQuorumCoverageSet.addBookie(4, BKException.Code.NoSuchLedgerExistsException);
        rrQuorumCoverageSet.addBookie(5, BKException.Code.OK);
        rrQuorumCoverageSet.addBookie(6, BKException.Code.NoSuchLedgerExistsException);
        rrQuorumCoverageSet.addBookie(7, BKException.Code.OK);
        rrQuorumCoverageSet.addBookie(8, BKException.Code.NoSuchLedgerExistsException);
        /*
