...
/**
 * Copied from JDK 9 
 * http://hg.openjdk.java.net/jdk9/hs/jdk/file/dd0b279b0565/src/java.base/share/classes/java/util/zip/CRC32C.java
 * 
 * Some methods removed to match Checksum interface definition in JDK 8.
 * Can be safely replaced with JDK's version after transition to JDK9+.
 */
...
public final class CRC32C implements Checksum {
    ...
    private static Unsafe getUnsafe() {
        ...
        try {
            ...
            throw new SecurityException("failed to access Unsafe class");
        }
    }
