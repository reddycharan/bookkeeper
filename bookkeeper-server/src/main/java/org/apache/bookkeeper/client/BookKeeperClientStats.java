...
public interface BookKeeperClientStats {
    ...
    String GET_LIST_OF_ENTRIES_OF_A_LEDGER_OP = "GET_LIST_OF_ENTRIES_OF_A_LEDGER";
    ...
    String TIMEOUT_GET_LIST_OF_ENTRIES_OF_A_LEDGER = "TIMEOUT_GET_LIST_OF_ENTRIES_OF_A_LEDGER";
