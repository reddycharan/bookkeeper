        ...
        int runCmd(CommandLine cmdLine) throws Exception {
            ...
            try {
                ...
                if (getter) {
                    ...
                    int lostBookieRecoveryDelay = Integer.valueOf(cmdLine.getOptionValue("set"));
    ...
    class DecommissionBookieCmd extends MyCommand {
        ...
        public int runCmd(CommandLine cmdLine) throws Exception {
            ...
            try {
                ...
                if (urLedgerIterator.hasNext()) {
                    ...
                    LOG.warn("Still in some underreplicated ledgers metadata, this bookie is part of its ensemble. "
        ...
        private void waitForLedgersToBeReplicated(Collection<Long> ledgers, BookieSocketAddress thisBookieAddress,
            ...
            while (!ledgers.isEmpty()) {
                ...
                long sleepTimeForThisCheck = ledgers.size() * sleepTimePerLedger > maxSleepTimeInBetweenChecks
        ...
        private boolean areEntriesOfSegmentStoredInTheBookie(LedgerMetadata ledgerMetadata,
             ...
             * check no fragments.
             * 
             * Basically we are checking for empty last segment in a closed ledger.
             * 
