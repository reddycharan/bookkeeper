...
public class BookieShell implements Tool {
    ...
    class NukeExistingCluster extends MyCommand {
        ...
        NukeExistingCluster() {
            ...
            opts.addOption("f", "force", false,
                    "If instanceid is not specified, then whether to force nuke the "
        ...
        int runCmd(CommandLine cmdLine) throws Exception {
            ...
            if ((zkledgersrootpath == null) || (force == (instanceid != null))) {
                LOG.error("zkledgersrootpath should be specified and either force option or instanceid should be "
